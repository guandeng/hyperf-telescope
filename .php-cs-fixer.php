...
return (new Config())
    ->setHeaderComment(
        projectName: 'guandeng/hyperf-telescope',
        projectLink: 'https://github.com/guandeng/hyperf-telescope',
        projectDocument: 'https://github.com/guandeng/hyperf-telescope/blob/main/README.md',
        contacts: [
            'guandeng@gmail.com',
        ],
    )
